      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map(({ icon, value, label }) => (
            <div
              key={label}
              className="group flex flex-col items-center text-center p-4 bg-zinc-900 border border-zinc-800 hover:border-[#F59E0B]/50 rounded-2xl transition-all duration-300"
            >
