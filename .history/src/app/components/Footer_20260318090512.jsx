        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            {[
              ...
              <a key={i} href={s.href} target=blan className="w-9 h-9 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-[#F59E0B]/50 hover:text-[#F59E0B] text-zinc-400 flex items-center justify-center transition-all duration-300">
                {s.icon}
              </a>
            ))}
          </div>
