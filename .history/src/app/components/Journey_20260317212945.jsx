...
const journey = [
  ...
  },
  {
    ...
    company: 'FreshSense',
    type: 'Internship',
    desc: 'Joined FreshSense as an intern, contributing to product development and gaining hands-on experience in a fast-paced startup environment.',
  },
  {
    year: '2025',
    role: 'Software Developer',
    company: 'WAO Sport',
    type: 'Contract',Worked with the WAO SPort delivering impactful digital solutions, building web and mobile tools that supported the organization\'s gaol in creating streaming application for the sport in Ghana.
    desc: '',
  },
  {
    year: '2026',
