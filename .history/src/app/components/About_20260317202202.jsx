import { ArrowRight, Code2, Smartphone, BarChart2 } from 'lucide-react';
import heroImage from '../../assets/afa-1.png';

const skills = [
  { icon: <Code2 className="w-4 h-4 text-[#F59E0B]" />, label: 'React / Next.js' },
  { icon: <Smartphone className="w-4 h-4 text-[#F59E0B]" />, label: 'Flutter / Dart' },
  { icon: <BarChart2 className="w-4 h-4 text-[#F59E0B]" />, label: 'Data Dashboards' },
  { icon: <Code2 className="w-4 h-4 text-[#F59E0B]" />, label: 'Node.js / APIs' },
];
