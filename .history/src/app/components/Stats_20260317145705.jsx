...
const stats = [
  { icon: <Briefcase className="w-8 h-8 text-[#F59E0B]" />, value: '10+', label: 'Projects Completed' },
  { icon: <Clock className="w-8 h-8 text-[#F59E0B]" />, value: '2+', label: 'Years Experience' },
  { icon: <Star className="w-8 h-8 text-[#F59E0B]" />, value: '98%', label: 'Client Satisfaction' },
  { icon: <Zap className="w-8 h-8 text-[#F59E0B]" />, value: '< 24h', label: 'Response Time' },
];
