        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <Reveal className="relative group order-2 lg:order-1">
            ...
            <div className="absolute -top-4 -left-4 px-4 py-2 bg-zinc-900 border border-zinc-700 rounded-xl shadow-xl">
              <span className="text-sm font-semibold text-[#F59E0B]" style={{ fontFamily: 'Geist, sans-serif' }}>Based In Rwanda</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={150} className="space-y-6 order-1 lg:order-2">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a href="#contact" className="inline-flex items-center gap-2 px-6 py-3 bg-[#F59E0B] hover:bg-[#F59E0B]/90 text-[#18181B] font-semibold rounded-lg transition-all duration-300 hover:scale-105" style={{ fontFamily: 'Geist, sans-serif' }}>
                Work With Me <ArrowRight className="w-4 h-4" />
              </a>
              <a href="#projects" className="inline-flex items-center gap-2 px-6 py-3 border border-zinc-700 hover:border-[#F59E0B] text-white font-semibold rounded-lg transition-all duration-300" style={{ fontFamily: 'Geist, sans-serif' }}>
                View Projects
              </a>
            </div>
          </Reveal>
